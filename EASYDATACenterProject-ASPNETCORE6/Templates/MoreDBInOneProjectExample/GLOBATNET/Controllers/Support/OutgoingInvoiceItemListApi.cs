...
namespace GLOBALNET.Controllers
{
    ...
    public class GLOBALNETOutgoingInvoiceItemListApi : ControllerBase
    {
        ...
        public async Task<string> GetOutgoingInvoiceItemListKey(string documentNumber)
        {
            ...
            { data = new GLOBALNETContext().OutgoingInvoiceItemLists.Where(a => a.DocumentNumber == documentNumber).ToList(); }
        ...
        public async Task<string> InsertAllDocOutgoingInvoiceItemList([FromBody] List<OutgoingInvoiceItemList> record)
        {
            ...
            {
                int result;
                var test = new GLOBALNETContext(); test.OutgoingInvoiceItemLists.AddRange(record);
        ...
        public async Task<string> DeleteItemList(string documentNumber)
        {
            try
            {
                List<OutgoingInvoiceItemList> data;
                data = new GLOBALNETContext().OutgoingInvoiceItemLists.Where(a => a.DocumentNumber == documentNumber).ToList(); 
                var test = new GLOBALNETContext(); test.OutgoingInvoiceItemLists.RemoveRange(data);
