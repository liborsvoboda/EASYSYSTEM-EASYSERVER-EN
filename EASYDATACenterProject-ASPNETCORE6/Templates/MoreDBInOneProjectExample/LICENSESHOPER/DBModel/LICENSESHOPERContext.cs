...
{
    public partial class LICENSESHOPERContext : DbContext
    {
        public LICENSESHOPERContext()
        {
        }

        public LICENSESHOPERContext(DbContextOptions<LICENSESHOPERContext> options)
                    : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=192.168.1.141;Database=LICENSESHOPER;User ID=licenseshoper;Password=licenseshoper;",
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DocumentAdviceList>(entity =>
            {
                ...
                entity.HasIndex(e => e.BranchId, "IX_DocumentAdviceList");
