...
namespace GlobalNET.Pages
{
    ...
    /// </summary>
    public partial class TemplateListPageWithSubPage : UserControl
    {
        /// <summary>
        ...
        public ExtendedOfferList selectedRecord = new ExtendedOfferList();
        ...
        /// 
        /// </summary>
        public TemplateListPageWithSubPage()
        {
            InitializeComponent();
        ...
        public async Task<bool> LoadDataList()
        {
            ...
            try
            {
                ...
                DocumentAdviceList = await ApiCommunication.GetApiRequest<DocumentAdviceList>(ApiUrls.GlobalNETDocumentAdviceList, "offer/" + defaultAddress.Id, App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (dBResult.recordCount > 0)
                {
                    ...
                    dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.GlobalNETOfferItemList, dBResult.status, App.UserData.Authentification.Token);
                    ...
                    dBResult = await ApiCommunication.PutApiRequest(ApiUrls.GlobalNETOfferItemList, httpContent, null, App.UserData.Authentification.Token);
        ...
        private async void SetRecord(bool showForm, bool copy = false)
        {
            ...
            if (showForm)
            {
                DocumentItemList = await ApiCommunication.GetApiRequest<List<DocumentItemList>>(ApiUrls.GlobalNETOfferItemList, originalDocumentNumber, App.UserData.Authentification.Token);
