...
namespace PRUVODKY
{
    public partial class OperationListPage : UserControl
    {
        ...
        public OperationList selectedRecord = new OperationList();
        ...
        public async Task<bool> LoadDataList()
        {
            ...
            try { if (MainWindow.serviceRunning) tempPartList = await ApiCommunication.GetApiRequest<List<PartList>>(ApiUrls.PRUVODKYPartList, null, App.UserData.Authentification.Token); }
            catch { }
            ...
            try { if (MainWindow.serviceRunning) DgListView.ItemsSource = OperationList = await ApiCommunication.GetApiRequest<List<OperationList>>(ApiUrls.PRUVODKYOperationList, null, App.UserData.Authentification.Token); }
            catch { }
        ...
        private void DgListView_Translate(object sender, EventArgs ex)
        {
            ((DataGrid)sender).Columns.ToList().ForEach(e =>
            {
                ...
                else if (headername == "PcsPerHour") { e.Header = Resources["pcsPerHour"].ToString(); e.CellStyle = Styles.gridTextRightAligment; }
                else if (headername == "KcPerKs") { e.Header = Resources["kcPerKs"].ToString(); e.CellStyle = Styles.gridTextRightAligment; }
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                { dBResult = await ApiCommunication.PutApiRequest(ApiUrls.PRUVODKYOperationList, httpContent, null, App.UserData.Authentification.Token); ;
                } else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.PRUVODKYOperationList, httpContent, null, App.UserData.Authentification.Token); ; }
