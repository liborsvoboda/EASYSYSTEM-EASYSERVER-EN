...
namespace GlobalNET.Pages {
    ...
    public partial class LicenseAlgorithmListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try
            {
                cb_address.ItemsSource = AddressList = await ApiCommunication.GetApiRequest<List<AddressList>>(ApiUrls.AddressList, null, App.UserData.Authentification.Token);
                cb_item.ItemsSource = ItemList = await ApiCommunication.GetApiRequest<List<ItemList>>(ApiUrls.ItemList, null, App.UserData.Authentification.Token);
                ...
                if (MainWindow.serviceRunning) licenseAlgorithmList = await ApiCommunication.GetApiRequest<List<LicenseAlgorithmList>>(ApiUrls.LicenseAlgorithmList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
        ...
        public async void DeleteRecord() {
            ...
            {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.LicenseAlgorithmList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try
            {
                ...
                {
                    dBResult = await ApiCommunication.PutApiRequest(ApiUrls.LicenseAlgorithmList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.LicenseAlgorithmList, httpContent, null, App.UserData.Authentification.Token); }
