    ...
    public partial class LicenseActivationFailListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try
            {
                ...
                {
                    DgListView.ItemsSource = await ApiCommunication.GetApiRequest<List<LicenseActivationFailList>>(ApiUrls.LicenseActivationFailList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
                }
            }
