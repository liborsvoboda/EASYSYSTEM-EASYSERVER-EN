...
namespace GlobalNET.Pages {
    ...
    public partial class PersonListPage : UserControl//, INotifyPropertyChanged
    {
        ...
        public static PersonList selectedRecord = new PersonList();
        ...
        public async Task<bool> LoadDataList() {
            ...
            try { if (MainWindow.serviceRunning) GroupList = await ApiCommunication.GetApiRequest<List<GroupList>>(ApiUrls.GroupList, null, App.UserData.Authentification.Token); }
            catch { }

            List<PersonList> data = new List<PersonList>();
            try { if (MainWindow.serviceRunning) data = await ApiCommunication.GetApiRequest<List<PersonList>>(ApiUrls.PersonList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token); }
            catch { }
        ...
        public async void DeleteRecord() {
            ...
            {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.PersonList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private void DgListView_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            ...
            else { selectedRecord = new PersonList(); }
            dataViewSupport.SelectedRecordId = selectedRecord.Id;
            SetRecord(false);
        }
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try
            {
                ...
                {
                    dBResult = await ApiCommunication.PutApiRequest(ApiUrls.PersonList, httpContent, null, App.UserData.Authentification.Token); ;
                }
                else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.PersonList, httpContent, null, App.UserData.Authentification.Token); ; }
