...
namespace GlobalNET.Pages {
    ...
    public partial class WarehouseListPage : UserControl {
        ...
        public async Task<bool> LoadDataList() {
            ...
            try
            {
                DgListView.ItemsSource = await ApiCommunication.GetApiRequest<List<WarehouseList>>(ApiUrls.WarehouseList, (dataViewSupport.AdvancedFilter == null) ? null : "Filter/" + WebUtility.UrlEncode(dataViewSupport.AdvancedFilter.Replace("[!]", "").Replace("{!}", "")), App.UserData.Authentification.Token);
            }
            catch (Exception autoEx) { App.ApplicationLogging(autoEx); }
        ...
        public async void DeleteRecord() {
            ...
            {
                DBResultMessage dBResult = await ApiCommunication.DeleteApiRequest(ApiUrls.WarehouseList, selectedRecord.Id.ToString(), App.UserData.Authentification.Token);
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e) {
            try
            {
                ...
                {
                    dBResult = await ApiCommunication.PutApiRequest(ApiUrls.WarehouseList, httpContent, null, App.UserData.Authentification.Token);
                }
                else { dBResult = await ApiCommunication.PostApiRequest(ApiUrls.WarehouseList, httpContent, null, App.UserData.Authentification.Token); }
