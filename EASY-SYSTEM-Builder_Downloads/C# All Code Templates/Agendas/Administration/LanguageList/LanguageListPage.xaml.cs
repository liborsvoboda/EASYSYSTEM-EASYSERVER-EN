...
namespace GlobalNET.Pages {
    ...
    public partial class LanguageListPage : UserControl {
        public static DataViewSupport dataViewSupport = new DataViewSupport();
        public static LanguageList selectedRecord = new LanguageList();
        ...
        public void Filter(string filter) {
            try
            {
                ...
                {
                    LanguageList user = e as LanguageList;
        ...
        public void EditRecord(bool copy) {
            selectedRecord = (LanguageList)DgListView.SelectedItem;
            dataViewSupport.SelectedRecordId = selectedRecord.Id;
            SetRecord(true, copy);
        }
        ...
        private void DgListView_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            ...
            { selectedRecord = (LanguageList)DgListView.SelectedItem; }
            else { selectedRecord = new LanguageList(); }
            dataViewSupport.SelectedRecordId = selectedRecord.Id;
            SetRecord(false);
        }
        ...
        private void BtnCancel_Click(object sender, RoutedEventArgs e) {
            selectedRecord = (DgListView.SelectedItems.Count > 0) ? (LanguageList)DgListView.SelectedItem : new LanguageList();
            SetRecord(false);
        }
